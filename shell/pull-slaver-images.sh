...
docker pull registry.cn-qingdao.aliyuncs.com/wangdali/nginx-ingress-controller:0.23.0
docker tag registry.cn-qingdao.aliyuncs.com/wangdali/nginx-ingress-controller:0.23.0 quay.io/kubernetes-ingress-controller/nginx-ingress-controller:0.23.0
docker rmi registry.cn-qingdao.aliyuncs.com/wangdali/nginx-ingress-controller:0.23.0
